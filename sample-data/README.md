...
| Gateway observability eval | `week-06-observability` | timeout classification, invalid JSON handling, provider retryability, cost policy blocks, latency warnings, trace/model/prompt version recording |
