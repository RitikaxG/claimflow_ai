...
export function RunAgentStepScreen() {
    ...
    const isRunningAgentStep = useDashboardStore((state) => state.isRunningAgentStep);
            ...
            <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
                <div>
                    ...
                    <p className="mt-1 max-w-2xl text-sm text-gray-500">
                        Run one guarded workflow step for this claim. This page shows
                        the proposed action, guardrail result, draft output, and audit
                        logs for this run only. If a follow-up is drafted, continue from
